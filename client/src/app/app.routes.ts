...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'templates',    loadComponent: () => import('./pages/templates/templates.component'),           canActivate: [adminGuard] },
      { path: 'templates/:id', loadComponent: () => import('./pages/template-detail/template-detail.component'), canActivate: [adminGuard] },
